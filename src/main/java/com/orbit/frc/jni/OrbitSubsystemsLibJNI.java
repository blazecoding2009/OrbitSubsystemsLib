 ...
 */
public class OrbitSubsystemsLibJNI {
  static boolean libraryLoaded = false;
  static RuntimeLoader<OrbitSubsystemsLibJNI> loader = null;
  ...
  static {
    if (Helper.getExtractOnStaticLoad()) {
      try {
        loader = new RuntimeLoader<>("OrbitSubsystemsLibDriver", RuntimeLoader.getDefaultExtractionRoot(), OrbitSubsystemsLibJNI.class);
        loader.loadLibrary();
